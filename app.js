...
let currentStudyRoomTime = 90; // in minutes, default 0
    ...
    modal.innerHTML = `
        <div class="modal-content">
            ...
            <div style="padding: 20px;">
                <p style="margin-bottom: 15px; font-size: 16px;">Are you sure you want to download this resource? ${points} pts will be used to unlock this resource</p>
